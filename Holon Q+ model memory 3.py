...
class EnergyHolon:
    ...
    def convert(self, core_holon):
        materials_needed = 9 * self.activity_level
        energy_generated = 6 * self.activity_level
...
class EnergyDisposalHolon:
    ...
    def dispose(self, core_holon):
        if core_holon.energy > 70:  # Change the condition to dispose energy at higher levels
